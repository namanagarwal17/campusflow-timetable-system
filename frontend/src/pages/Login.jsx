  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 transition-colors duration-300 dark:bg-slate-950 dark:text-white">
      <div className="mx-auto flex min-h-screen max-w-7xl items-center justify-center px-6 py-10 md:px-10">
        <div className="grid w-full max-w-6xl overflow-hidden rounded-[32px] border border-slate-200 bg-white shadow-2xl shadow-slate-200/60 transition-colors duration-300 dark:border-white/10 dark:bg-white/5 dark:shadow-cyan-500/10 lg:grid-cols-2">
          <div className="relative hidden overflow-hidden bg-gradient-to-br from-cyan-500 via-sky-500 to-purple-500 p-10 text-white lg:flex lg:flex-col lg:justify-between">
            ...
            <div className="w-full max-w-md">
              ...
              <form onSubmit={handleLogin} className="space-y-5">
                <div>
                  ...
                  <div className="flex items-center gap-3 rounded-2xl border border-slate-300 bg-slate-50 px-4 py-3 transition-all duration-200 hover:border-cyan-400 focus-within:border-cyan-400 dark:border-white/10 dark:bg-slate-900/60 dark:hover:border-cyan-400/30">
                ...
                <button
                  type="submit"
                  className="inline-flex w-full items-center justify-center gap-2 rounded-2xl bg-cyan-500 px-5 py-3.5 font-semibold text-white transition-all duration-200 hover:scale-[1.02] hover:bg-cyan-400 hover:shadow-lg hover:shadow-cyan-500/30"
                >
                  Login
                  <ArrowRight size={18} />
                </button>
