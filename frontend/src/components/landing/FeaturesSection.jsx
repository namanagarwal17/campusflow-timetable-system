        ...
        <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
          {features.map((item, index) => {
            ...
            return (
              <div
                key={index}
                className="group rounded-3xl border border-slate-200 bg-white p-6 shadow-sm transition duration-300 hover:-translate-y-1 hover:border-purple-500/30 hover:shadow-lg hover:shadow-purple-500/10 dark:border-white/10 dark:bg-white/5 dark:hover:border-purple-400/30"
              >
                <div className="mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-purple-100 text-purple-700 transition group-hover:bg-purple-200 dark:bg-purple-500/10 dark:text-purple-300 dark:group-hover:bg-purple-500/20">
                  <Icon size={24} />
                </div>
