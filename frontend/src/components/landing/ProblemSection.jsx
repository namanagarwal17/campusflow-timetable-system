        ...
        <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
          {problems.map((item, index) => {
            ...
            return (
              <div
                key={index}
                className="group rounded-3xl border border-slate-200 bg-white p-6 shadow-sm transition duration-300 hover:-translate-y-1 hover:border-cyan-500/30 hover:shadow-lg hover:shadow-cyan-500/10 dark:border-white/10 dark:bg-white/5 dark:hover:border-cyan-400/30"
              >
                <div className="mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-cyan-100 text-cyan-700 transition group-hover:bg-cyan-200 dark:bg-cyan-400/10 dark:text-cyan-300 dark:group-hover:bg-cyan-400/20">
                  <Icon size={24} />
                </div>
