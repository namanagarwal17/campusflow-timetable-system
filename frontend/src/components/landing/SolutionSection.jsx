        ...
        <div>
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2">
            {[
              ...
              >
                <h3 className="text-lg font-semibold text-cyan-600 dark:text-cyan-300">{title}</h3>
            ...
            {flow.map((item, index) => {
              ...
              return (
                <div key={index} className="relative">
                  ...
                  {index !== flow.length - 1 && (
                    <div className="ml-6 mt-2 h-6 w-px bg-gradient-to-b from-cyan-400/50 to-purple-400/30" />
                  )}
                </div>
              );
            })}
