            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {stack.map((item, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="rounded-2xl border border-slate-200 bg-slate-50 p-5 transition hover:border-cyan-500/30 dark:border-white/10 dark:bg-slate-900/60 dark:hover:border-cyan-400/30"
                  >
                    <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-2xl bg-cyan-100 text-cyan-700 dark:bg-cyan-400/10 dark:text-cyan-300">
                      <Icon size={22} />
                    </div>
