...
const fallbackRooms = [
  { id: 1, name: "R-101", capacity: 60, type: "Classroom" },
  { id: 2, name: "Lab-1", capacity: 40, type: "Lab" },
];
          ...
          {loading ? (
            ...
            <div className="grid gap-4">
              {rooms.map((item) => (
                <div
                  key={item.id}
                  className="flex items-center justify-between rounded-2xl border border-slate-200 bg-slate-50 p-4 transition-all duration-200 hover:border-blue-500/20 hover:bg-slate-100 dark:border-white/10 dark:bg-slate-900/60 dark:hover:border-blue-400/20 dark:hover:bg-slate-900"
                >
                  <div>
